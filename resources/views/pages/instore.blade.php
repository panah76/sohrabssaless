        ...
        <div class="framing-in">
            <div class="col-lg-8">
                <div class="code-arti bg-white">
                    <h1 class="mt-5 fw-bold">Prefessional Framing</h1>
        ...
        <div class="section-ba ">
            <div class="container-form">
                ...
                <form method="POST" action="{{route('store.post')}}">
                    @csrf
                    <div class="row">
                        <div class="col-md-4 p-lg-5 mt-4">
                            <div class="col-md-10 p-3">
                                <h2 class="mb-4">Get in quote</h2>

                                <p>Fill out this form to get an idea of our framing prices.We aim to respond to all
                                    enquiries within tow business days.</p><br>
                                <p>
                                    All quotes obtained through this service are estimates;for exact quotes,please visit
                                    our showroom.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 p-lg-5 mt-4">
                            <div class="col-md-10 p-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-75">
                                        <input type="text" id="lname" name="company"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-75">
                                        <input type="text" id="email" name="phone" placeholder="Contact Number..">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-75">
                                    <select id="country" name="service">
                                        ...
                                        <option value="framing">Standard Framing</option>
                                        <option value="3d">3D Box Framing</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 p-lg-5 mt-4">
                            <div class="col-md-10">
                                <div class="row">
                                    <div class="col-75 px-5">
                                    <textarea id="subject" name="comments" placeholder="Description:*
                                     Nature of work:
                                    Painting on paper/canvas,
                                    poster,sport shirt...
                                     Dimension (cm)
                                     preferred frame colour" style="height:280px"></textarea>
                                    </div>
                                </div>
