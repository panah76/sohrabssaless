...
<head>
    ...
    <title>Sohrab Shahid-Saless</title>
    ...
    <!-- =======================================================
    * Template Name: sohrab shahid saless - v1.3.1
    * Template URL: https://faamgallery.com
    * Author: zahrapanahi.art
    * License: https://sohrabshahidsaless.com
    ======================================================== -->
</head>
...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        <div class="container d-flex align-items-center">
         <h1 class="logo me-auto"><a href="index.html">Sohrab Shahid-Saless<span>1998</span></a></h1>
...
{{--            <a href="{{ url('/') }}" class="logo me-auto"><img src="{{asset('assets/img/FaamLogo.png')}}" alt="Faamgallery"></a>--}}
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li><a class="nav-link scrollto " href="{{route('printing')}}">MOVIES</a></li>
                    <li><a class="nav-link scrollto" href="{{ url('artworks') }}">INTERVIEWS</a></li>
